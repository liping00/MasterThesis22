...
% TEST LP change the dimension of control input
%tau2 = 0*tau1;
% test LP, as the dimention between u and y are different, to be deleted 
%u=u*10^6;
%tau = [0,u,0]'; % position in y-direction, LP
%tau = [u,0,0]'; %position in x-direction, LP
